...
public class COSDemo {
	public static void main(String[] args) throws Exception {
		...
		long appId = 1256173998;
		String secretId = "AKIDd9UdaMJjCWeeT6LphV8f1B9AFAsOrpjW";
		String secretKey = "lKhwy43tZ3PZZNzOdfVBf084nLk4DD1c";
		// 设置要操作的bucket
		String bucketName = "issue";
		// 初始化客户端配置
		...
		String cosFilePath = "/logo.png";
		String localFilePath1 = "src/test/resources/logo.png";
